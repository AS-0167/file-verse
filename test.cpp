...
int main() {
    ...
    // ------------------------------------------------------------------------
    status = fs_format("ofs_test.omni", "default_config.txt");
    print_test("Format FS", status);

    status = fs_init((void**)&fs, "ofs_test.omni", "default_config.txt");
    ...
    // ------------------------------------------------------------------------
    const char* data = "OFS System operational test content.";
